...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b border-white/10 text-xs uppercase tracking-wider font-sc text-slate-400", className)} {...props} />
));
...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-white/10 bg-slate-900/50 font-medium", className)}
    {...props}
  />
));
